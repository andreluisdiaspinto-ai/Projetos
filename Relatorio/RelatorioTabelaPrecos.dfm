object Form_RelatorioTabelaPrecos: TForm_RelatorioTabelaPrecos
  Left = 0
  Top = 0
  BorderIcons = []
  BorderStyle = bsNone
  ...
  object DBGridTabelaPrecos: TDBGrid
    Left = 0
    Top = 168
    Width = 990
    Height = 386
    ...
    OnDrawColumnCell = DBGridTabelaPrecosDrawColumnCell
    Columns = <
      item
        Expanded = False
        FieldName = 'CODIGO'
  ...
  object QueryTabelaPrecos: TIBQuery
    Database = DM.Conexao
    ...
    SQL.Strings = (
        ...
        'Select CODIGO, CODIGO_BARRAS, DESCRICAO, PRECO_VENDA from Produto o' +
        'rder by DESCRICAO')
    Left = 24
    Top = 495
  end
  object DsTabelaPrecos: TDataSource
    DataSet = QueryTabelaPrecos
    Left = 93
    Top = 496
  end
  object frxDBDatasetTabelaPrecos: TfrxDBDataset
    UserName = 'frxDBDatasetTabelaPrecos'
  ...
  object frxReportTabelaPrecos: TfrxReport
    Version = '2023.1.3'
    ...
    Datasets = <
      item
        DataSet = frxDBDatasetTabelaPrecos
        DataSetName = 'frxDBDatasetTabelaPrecos'
      end>
    Variables = <>
    Style = <>
  end
