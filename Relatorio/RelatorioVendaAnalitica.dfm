object Form_RelatorioVendaAnalitica: TForm_RelatorioVendaAnalitica
  Left = 0
  Top = 0
  BorderIcons = []
  BorderStyle = bsNone
  ...
  object DBGridVendaMestreDetalhe: TDBGrid
    Left = 0
    Top = 270
    Width = 1120
    Height = 384
    Align = alClient
    DataSource = DsVendaAnalitica
    ...
    TitleFont.Style = []
    OnDrawColumnCell = DBGridVendaMestreDetalheDrawColumnCell
    Columns = <
      item
        Expanded = False
        FieldName = 'CODIGO'
  ...
  object QueryVendaAnalitica: TIBQuery
    Database = DM.Conexao
    ...
    SQL.Strings = (
      ...
      'order by vc.DATA_HORA_VENDA, vc.CODIGO, vi.CODIGO')
    PrecommittedReads = False
    Left = 24
    Top = 495
  end
  object DsVendaAnalitica: TDataSource
    DataSet = QueryVendaAnalitica
    Left = 96
    Top = 496
  end
  object frxDBDatasetVendaAnalitica: TfrxDBDataset
    UserName = 'frxDBDatasetVendaAnalitica'
  ...
  object QueryGraficoPorDia: TIBQuery
    Database = DM.Conexao
    Transaction = DM.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
  ...
  object frxDBDatasetGraficoPorDia: TfrxDBDataset
    UserName = 'frxDBDatasetGraficoPorDia'
    CloseDataSource = False
    DataSet = QueryGraficoPorDia
    BCDToCurrency = False
    DataSetOptions = []
    Left = 288
    Top = 560
  end
  object frxReportVendaAnalitica: TfrxReport
    Version = '2023.1.3'
    ...
    ScriptText.Strings = (
      ...
      'begin'
        ...
        'aAnalitica."TOTAL_LIQUIDO">;'
      'end;'
      ''
      'procedure GroupFooterVendaOnBeforePrint(Sender: TfrxComponent);'
      'begin'
      
        '  TotalMestreBruto   := TotalMestreBruto + <frxDBDatasetVendaAna' +
        'litica."TOTAL_BRUTO_VENDA">;'
      
        '  TotalMestreLiquido := TotalMestreLiquido + <frxDBDatasetVendaA' +
        'nalitica."TOTAL_VENDA">;'
    ...
    Datasets = <
      item
        DataSet = frxDBDatasetVendaAnalitica
        DataSetName = 'frxDBDatasetVendaAnalitica'
      end
      item
        DataSet = frxDBDatasetGraficoPorDia
        DataSetName = 'frxDBDatasetGraficoPorDia'
      end>
    Variables = <
      item
        Name = 'Filtros'
    ...
    object Page1: TfrxReportPage
      ...
      object GroupHeaderDia: TfrxGroupHeader
        ...
        Width = 718.110700000000000000
        Condition = 'frxDBDatasetVendaAnalitica."DATA_VENDA"'
        ...
        object MemoDiaValor: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDatasetVendaAnalitica."DATA_VENDA"]')
          ParentFont = False
        end
      end
      object GroupHeaderVenda: TfrxGroupHeader
        ...
        Width = 718.110700000000000000
        Condition = 'frxDBDatasetVendaAnalitica."CODIGO"'
        ...
        object MemoVendaCodigo: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[FormatFloat('#39'000000'#39',<frxDBDatasetVendaAnalitica."CODIGO">)]')
          ParentFont = False
          WordWrap = False
        end
        ...
        object MemoVendaData: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDatasetVendaAnalitica."DATA_HORA_VENDA"]')
          ParentFont = False
          WordWrap = False
        end
        ...
        object MemoClienteCodigo: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[FormatFloat('#39'00000'#39',<frxDBDatasetVendaAnalitica."CODIGO_CLIENTE' +
              '">)]')
          ParentFont = False
          WordWrap = False
        end
        object MemoClienteNome: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[Copy(<frxDBDatasetVendaAnalitica."NOME_CLIENTE">,1,28)]')
          ParentFont = False
          WordWrap = False
        end
        ...
        object MemoSituacao: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDatasetVendaAnalitica."SITUACAO"]')
          ParentFont = False
          WordWrap = False
        end
      end
      object MasterData1: TfrxMasterData
        ...
        object MemoItemProduto: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[FormatFloat('#39'000000'#39',<frxDBDatasetVendaAnalitica."CODIGO_PRODUT' +
              'O">)]')
          ParentFont = False
          WordWrap = False
        end
        object MemoItemDescricao: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[Copy(<frxDBDatasetVendaAnalitica."DESCRICAO_PRODUTO">,1,40)]')
          ParentFont = False
          WordWrap = False
        end
        object MemoItemQuantidade: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FormatFloat('#39'0.000'#39',<frxDBDatasetVendaAnalitica."QUANTIDADE">)]')
          ParentFont = False
          WordWrap = False
        end
        object MemoItemPreco: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[FormatFloat('#39'0.00'#39',<frxDBDatasetVendaAnalitica."PRECO_UNITARIO"' +
              '>)]')
          ParentFont = False
          WordWrap = False
        end
        object MemoItemBruto: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FormatFloat('#39'0.00'#39',<frxDBDatasetVendaAnalitica."VALOR_BRUTO">)]')
          ParentFont = False
          WordWrap = False
        end
        object MemoItemDesconto: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FormatFloat('#39'0.00'#39',<frxDBDatasetVendaAnalitica."DESCONTO">)]')
          ParentFont = False
          WordWrap = False
        end
        object MemoItemAcrescimo: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FormatFloat('#39'0.00'#39',<frxDBDatasetVendaAnalitica."ACRESCIMO">)]')
          ParentFont = False
          WordWrap = False
        end
        object MemoItemTotalLiquido: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[FormatFloat('#39'0.00'#39',<frxDBDatasetVendaAnalitica."TOTAL_LIQUIDO">' +
              ')]')
          ParentFont = False
          WordWrap = False
        end
      ...
      object GroupFooterVenda: TfrxGroupFooter
        ...
        object MemoVendaTotBruto: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[FormatFloat('#39'0.00'#39',SUM(<frxDBDatasetVendaAnalitica."VALOR_BRUTO' +
              '">,MasterData1))]')
          ParentFont = False
          WordWrap = False
        end
        object MemoVendaTotDesconto: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[FormatFloat('#39'0.00'#39',SUM(<frxDBDatasetVendaAnalitica."DESCONTO">,' +
              'MasterData1))]')
          ParentFont = False
          WordWrap = False
        end
        object MemoVendaTotAcrescimo: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[FormatFloat('#39'0.00'#39',SUM(<frxDBDatasetVendaAnalitica."ACRESCIMO">' +
              ',MasterData1))]')
          ParentFont = False
          WordWrap = False
        end
        object MemoVendaTotLiquido: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[FormatFloat('#39'0.00'#39',SUM(<frxDBDatasetVendaAnalitica."TOTAL_LIQUI' +
              'DO">,MasterData1))]')
          ParentFont = False
          WordWrap = False
        end
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object MemoTituloGrafico: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            'Gr'#225'fico de barras - total l'#237'quido por dia')
          ParentFont = False
          WordWrap = False
        end
      end
