object Form_RelatorioVendaProduto: TForm_RelatorioVendaProduto
  Left = 0
  Top = 0
  BorderIcons = []
  BorderStyle = bsNone
  ...
  object PanelFiltros: TPanel
    ...
    object EditCodigoProduto: TEdit
      ...
      Width = 90
      Height = 25
      Hint = 'Filtra pelo c'#243'digo do produto (vazio = sem filtro)'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = 3355443
      Font.Height = -13
      Font.Name = 'Segoe UI'
    ...
    object EditDescricaoProduto: TEdit
      ...
      Width = 700
      Height = 25
      Hint = 'Filtra pelas descri'#231#245'es que come'#231'am pelo texto informado'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = 3355443
      Font.Height = -13
      Font.Name = 'Segoe UI'
  ...
  object DBGridVendaProduto: TDBGrid
    Left = 0
    Top = 270
    Width = 1120
    Height = 384
    ...
    TitleFont.Style = []
    OnDrawColumnCell = DBGridVendaProdutoDrawColumnCell
    Columns = <
      item
        Expanded = False
        FieldName = 'CODIGO'
      ...
      item
        Expanded = False
        FieldName = 'TOTAL_BRUTO_VENDA'
        Title.Alignment = taRightJustify
        Title.Caption = 'T. Bruto Venda'
        Width = 96
        Visible = True
      end
      item
  ...
  object QueryVendaProduto: TIBQuery
    Database = DM.Conexao
  ...
  object DsVendaProduto: TDataSource
    DataSet = QueryVendaProduto
    Left = 96
    Top = 496
  end
  object frxDBDatasetVendaProduto: TfrxDBDataset
    UserName = 'frxDBDatasetVendaProduto'
  ...
  object QueryGraficoPorProduto: TIBQuery
    Database = DM.Conexao
    Transaction = DM.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
  ...
  object frxDBDatasetGraficoPorProduto: TfrxDBDataset
    UserName = 'frxDBDatasetGraficoPorProduto'
    CloseDataSource = False
    DataSet = QueryGraficoPorProduto
    BCDToCurrency = False
    DataSetOptions = []
    Left = 288
    Top = 560
  end
  object frxReportVendaProduto: TfrxReport
    Version = '2023.1.3'
    ...
    Datasets = <
      item
        DataSet = frxDBDatasetVendaProduto
        DataSetName = 'frxDBDatasetVendaProduto'
      end
      item
        DataSet = frxDBDatasetGraficoPorProduto
        DataSetName = 'frxDBDatasetGraficoPorProduto'
      end>
    Variables = <
      item
        Name = 'Filtros'
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object MemoTituloRelatorio: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Relat'#243'rio de Venda por Produto')
          ParentFont = False
        end
      ...
      object GroupHeaderProduto: TfrxGroupHeader
        FillType = ftBrush
        FillGap.Top = 0
        FillGap.Left = 0
        FillGap.Bottom = 0
        ...
        Width = 718.110700000000000000
        Condition = 'frxDBDatasetVendaProduto."DESCRICAO_PRODUTO"'
        object ShapeProduto: TfrxShapeView
          AllowVectorExport = True
          Left = 3.779530000000000000
        ...
        object MemoProdutoGrupoLabel: TfrxMemoView
          AllowVectorExport = True
        ...
        object MemoProdutoGrupoCodigo: TfrxMemoView
          AllowVectorExport = True
          ...
          Memo.UTF8W = (
              ...
              '[FormatFloat('#39'000000'#39',<frxDBDatasetVendaProduto."CODIGO_PRODUTO"' +
              '>)]')
          ParentFont = False
        end
        object MemoProdutoGrupoNome: TfrxMemoView
          AllowVectorExport = True
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDatasetVendaProduto."DESCRICAO_PRODUTO"]')
          ParentFont = False
        end
      end
      object GroupHeaderVenda: TfrxGroupHeader
        ...
        Width = 718.110700000000000000
        Condition = 'frxDBDatasetVendaProduto."CODIGO"'
        ...
        object MemoVendaCodigo: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[FormatFloat('#39'000000'#39',<frxDBDatasetVendaProduto."CODIGO">)]')
          ParentFont = False
          WordWrap = False
        end
        ...
        object MemoVendaData: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDatasetVendaProduto."DATA_HORA_VENDA"]')
          ParentFont = False
          WordWrap = False
        end
        ...
        object MemoClienteCodigo: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[FormatFloat('#39'00000'#39',<frxDBDatasetVendaProduto."CODIGO_CLIENTE">' +
              ')]')
          ParentFont = False
          WordWrap = False
        end
        object MemoClienteNome: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[Copy(<frxDBDatasetVendaProduto."NOME_CLIENTE">,1,28)]')
          ParentFont = False
          WordWrap = False
        end
        ...
        object MemoSituacao: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDatasetVendaProduto."SITUACAO"]')
          ParentFont = False
          WordWrap = False
        end
      end
      object MasterData1: TfrxMasterData
        ...
        object MemoItemDescricao: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[Copy(<frxDBDatasetVendaProduto."DESCRICAO_PRODUTO">,1,40)]')
          ParentFont = False
          WordWrap = False
        end
        object MemoItemQuantidade: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FormatFloat('#39'0.000'#39',<frxDBDatasetVendaProduto."QUANTIDADE">)]')
          ParentFont = False
          WordWrap = False
        end
        object MemoItemPreco: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[FormatFloat('#39'0.00'#39',<frxDBDatasetVendaProduto."PRECO_UNITARIO">)' +
              ']')
          ParentFont = False
          WordWrap = False
        end
        object MemoItemBruto: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FormatFloat('#39'0.00'#39',<frxDBDatasetVendaProduto."VALOR_BRUTO">)]')
          ParentFont = False
          WordWrap = False
        end
        object MemoItemDesconto: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FormatFloat('#39'0.00'#39',<frxDBDatasetVendaProduto."DESCONTO">)]')
          ParentFont = False
          WordWrap = False
        end
        object MemoItemAcrescimo: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FormatFloat('#39'0.00'#39',<frxDBDatasetVendaProduto."ACRESCIMO">)]')
          ParentFont = False
          WordWrap = False
        end
        object MemoItemTotalLiquido: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FormatFloat('#39'0.00'#39',<frxDBDatasetVendaProduto."TOTAL_LIQUIDO">)]')
          ParentFont = False
          WordWrap = False
        end
      end
      object GroupFooterVenda: TfrxGroupFooter
        ...
        object MemoVendaTotBruto: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[FormatFloat('#39'0.00'#39',SUM(<frxDBDatasetVendaProduto."VALOR_BRUTO">' +
              ',MasterData1))]')
          ParentFont = False
          WordWrap = False
        end
        object MemoVendaTotDesconto: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[FormatFloat('#39'0.00'#39',SUM(<frxDBDatasetVendaProduto."DESCONTO">,Ma' +
              'sterData1))]')
          ParentFont = False
          WordWrap = False
        end
        object MemoVendaTotAcrescimo: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[FormatFloat('#39'0.00'#39',SUM(<frxDBDatasetVendaProduto."ACRESCIMO">,M' +
              'asterData1))]')
          ParentFont = False
          WordWrap = False
        end
        object MemoVendaTotLiquido: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[FormatFloat('#39'0.00'#39',SUM(<frxDBDatasetVendaProduto."TOTAL_LIQUIDO' +
              '">,MasterData1))]')
          ParentFont = False
          WordWrap = False
        end
      end
      object GroupFooterProduto: TfrxGroupFooter
        FillType = ftBrush
        FillGap.Top = 0
        FillGap.Left = 0
        FillGap.Bottom = 0
        ...
        Width = 718.110700000000000000
        object ShapeProdutoFooter: TfrxShapeView
          AllowVectorExport = True
          Left = 3.779530000000000000
          Top = 1.000000000000000000
          Width = 714.307470000000000000
        ...
        object MemoProdutoTotLabel: TfrxMemoView
          AllowVectorExport = True
          Left = 6.000000000000000000
          Top = 2.000000000000000000
        ...
        object MemoProdutoTotBruto: TfrxMemoView
          AllowVectorExport = True
          Left = 452.000000000000000000
          Top = 2.000000000000000000
          Width = 68.000000000000000000
        ...
        object MemoProdutoTotDesconto: TfrxMemoView
          AllowVectorExport = True
          Left = 522.000000000000000000
          Top = 2.000000000000000000
          Width = 60.000000000000000000
        ...
        object MemoProdutoTotAcrescimo: TfrxMemoView
          AllowVectorExport = True
          Left = 584.000000000000000000
          Top = 2.000000000000000000
          Width = 60.000000000000000000
        ...
        object MemoProdutoTotLiquido: TfrxMemoView
          AllowVectorExport = True
          Left = 646.000000000000000000
          Top = 2.000000000000000000
          Width = 72.000000000000000000
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object MemoTituloGrafico: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            'Gr'#225'fico de barras 3D - total l'#237'quido por produto')
          ParentFont = False
          WordWrap = False
        end
      end
