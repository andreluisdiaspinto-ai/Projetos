object Form_EmiteEtiquetaProdutoGondula: TForm_EmiteEtiquetaProdutoGondula
  Left = 0
  Top = 0
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'Gerador de Etiquetas de Produto'
  ClientHeight = 620
  ClientWidth = 990
  Color = 16119285
  ...
  object PanelRodape: TPanel
    ...
    object BtnImprimir: TBitBtn
      ...
      Width = 130
      Height = 42
      Hint = 'Gerar e imprimir as etiquetas'
      Caption = '&Imprimir'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clNavy
      Font.Height = -13
  ...
  object QueryProduto: TIBQuery
    ...
    SQL.Strings = (
        ...
        ' ESTOQUE_ATUAL, CODIGO_BARRAS from Produto order by DESCRICAO')
    Left = 24
    Top = 495
  end
